...
// Or bound by attempt count instead of time: 1 initial attempt + 5 retries.
// Errors with LockError::RetriesExhausted if every attempt fails.
let guard = mutex.try_lock_with_retries(5).await?;
```
