...
let r = rw.try_read_with_timeout(Duration::from_secs(2)).await?; // time-bounded
let r = rw.try_read_with_retries(5).await?;            // retry-bounded
...
let w = rw.try_write_with_timeout(Duration::from_secs(2)).await?; // time-bounded
let w = rw.try_write_with_retries(5).await?;            // retry-bounded
